...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'edilson.mendes@primeconsulting.org' =>
            ['#subject#' => 'Reservation Form Edificio Magico',
    ...
    try {
       ...
       $message = Swift_Message::newInstance()
         ...
         $image_ilha = $message->embed(Swift_Image::fromPath('img/saonicolau.png'));
            $image_logo = $message->embed(Swift_Image::fromPath('img/logotipo.png'));

        // create the first part of the HTML output
        $html = <<<EOT
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>Edificio Magico</title>
</head>
...
center">Reservation Form Edificio Magico</h1>
</td>
</tr>
<tr>
